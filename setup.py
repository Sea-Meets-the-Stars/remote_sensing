...
# Begin setup
setup_keywords = dict()
setup_keywords['name'] = 'remote_sensing'
setup_keywords['description'] = 'Tools for Remote Sensing Data'
setup_keywords['author'] = 'J. Xavier Prochaska et al.'
setup_keywords['author_email'] = 'jxp@ucsc.edu'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/AI-for-Ocean-Science/remote_sensing'
